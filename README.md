...
```kotlin
dependencies {
    implementation(files("libs/handball-toolkit-0.6.1.aar"))
...
|---|---|
| コア crate | `0.6.1` |
| `.aar` ファイル名 | `handball-toolkit-0.6.1.aar` |
| git タグ / Release | `v0.6.1` |
...
```bash
./scripts/build_aar.sh                     # → target/aar/handball-toolkit-<version>.aar
gh release create v0.6.1 target/aar/handball-toolkit-0.6.1.aar \
  --title "v0.6.1" --notes "..."
```
