...
```kotlin
dependencies {
    implementation(files("libs/handball-toolkit-0.6.0.aar"))
...
|---|---|
| コア crate | `0.6.0` |
| `.aar` ファイル名 | `handball-toolkit-0.6.0.aar` |
| git タグ / Release | `v0.6.0` |
...
```bash
./scripts/build_aar.sh                     # → target/aar/handball-toolkit-<version>.aar
gh release create v0.6.0 target/aar/handball-toolkit-0.6.0.aar \
  --title "v0.6.0" --notes "..."
```
